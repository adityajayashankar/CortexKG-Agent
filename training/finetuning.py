...
Hardware: 1x T4 GPU (Google Colab Free), A100, or RTX 3090/4090.
...
def main():
    ...
    # ── FIX: max_seq_length belongs in SFTTrainer, NOT SFTConfig ──────────
    # In TRL >= 0.8.x, passing max_seq_length to SFTConfig throws:
    #   TypeError: SFTConfig.__init__() got an unexpected keyword argument 'max_seq_length'
    # Solution: remove it from SFTConfig and pass it directly to SFTTrainer below.
    training_args = SFTConfig(
        ...
        report_to                    = "none",
        # max_seq_length removed from here ↑
    )
    ...
    trainer = SFTTrainer(
        ...
        max_seq_length = 1024,           # ← moved here, this is the correct place
    )
